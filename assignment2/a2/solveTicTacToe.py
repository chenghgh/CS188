...
class TicTacToeAgent():
    ...
    def __init__(self):
        ...
        # 6 7 8
        self.fingerprint = {}
        listc = [[False, False, False, False, False, False, False, False, False]]

        listcc = [[False, False, False, False, True, False, False, False, False]]

        listad = [[True, True, False, False, False, False, False, False, False]]

        listb = [[True, False, True, False, False, False, False, False, False],
        ...
        lista = [[True, False, False, False, False, False, False, False, True],
        ...
        listab = [[True, True, False, False, True, False, False, False, False],
                [True, False, True, False, False, False, True, False, False],
                [False, True, False, True, True, False, False, False, False],
                [True, True, False, False, False, True, False, True, False],
                [True, True, False, False, False, True, False, False, True]]

        listd = [[True, True, False, False, False, True, False, False, False],
                [True, True, False, False, False, False, False, True, False],
                [True, True, False, False, False, False, False, False, True]]

        self.fingerprint["c"] = listc
        self.fingerprint["cc"] = listcc
        self.fingerprint["ad"] = listad
        self.fingerprint["b"] = listb
        self.fingerprint["a"] = lista
        self.fingerprint["ab"] = listab
        self.fingerprint["d"] = listd

        self.pset = {"a", "bb", "bc", "cc"}

    def getIsomorphicBoards(self, board):
        # 8 items
        boardList = [board]

        boardTransfer = [board[col*3 + row] for row in range(3) for col in range(3)]
        boardList.append(boardTransfer)
        boardList.append(board[::-1])
        boardList.append(boardTransfer[::-1])

        # rotate
        for item in range(4):
            boardList.append([boardList[item][col*3+row] for row in range(3) for col in range(2,-1,-1)])
        return boardList

    def getFingerPrint(self, boardList):
        for board in boardList:
            if board in self.fingerprint["c"]:
                return "c"
            if board in self.fingerprint["cc"]:
                return "cc"
            if board in self.fingerprint["ad"]:
                return "ad"
            if board in self.fingerprint["b"]:
                return "b"
            if board in self.fingerprint["a"]:
                return "a"
            if board in self.fingerprint["ab"]:
                return "ab"
            if board in self.fingerprint["d"]:
                return "d"
        return ""

    def checkInP(self, successor, gameRules):
        boards = successor.boards
        fingerprints = ""

        for board in boards:
            boardList = self.getIsomorphicBoards(board)
            fingerPrint = self.getFingerPrint(boardList)
        ...
        # print("fingerprints:",''.join(fingerprints))
        # print("checkIn:",''.join(fingerprints) in self.pset)
        return (''.join(fingerprints) in self.pset)

    # idea from the paper 1301.1672
    def getAction(self, gameState, gameRules):
        ...
        for action in actions:
            ...
            if self.checkInP(successor, gameRules): return action
        return actions[0]
